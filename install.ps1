...
.DESCRIPTION
    ...
    elevation, and optionally starts SimHub again. Settings need nothing installed: on a
    machine with none saved, the plugin writes its shipped profiles out on first start.
